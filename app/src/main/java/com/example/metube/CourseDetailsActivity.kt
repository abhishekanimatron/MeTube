...
//        recyclerView_main.adapter = CourseDetailAdapter()
    ...
    private fun fetchJson() {
        //The individual content tiles id
    ...
    private class CourseDetailAdapter(val courseLessons: Array<CourseLesson>) :
        ...
        override fun onBindViewHolder(holder: CourseLessonViewHolder, position: Int) {
            ...
            holder.customView.textView_courseLessonTitle.text = courseLesson.name
            holder.customView.textView_courseLessonDuration.text = courseLesson.duration
            val imageView = holder.customView.imageView_courseLessonThumbnail
            Glide.with(holder.customView.context).load(courseLesson.imageUrl).into(imageView)
    ...
    class CourseLessonViewHolder(
        ...
        init {
            customView.setOnClickListener {
                println("An attempt to open WebView was made.")
